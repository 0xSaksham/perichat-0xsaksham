...
import { GenerateOutlineIcon, TextFileIcon } from "@/app/utils/Icons";
    ...
    <>
      ...
      <div className="border-t border-gray-200 py-2.5">
        ...
        <nav className="flex items-center justify-between px-2 sm:px-4 mt-2 ml-3.5 sm:mt-3 mx-auto">
          ...
          <button
            className="flex items-center px-1 py-0.5 ml-2 text-black text-sm bg-white border border-gray-300 rounded-md hover:bg-gray-100 transition whitespace-nowrap cursor-pointer"
