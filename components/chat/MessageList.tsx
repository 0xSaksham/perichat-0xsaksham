...
export const MessageList = ({
  ...
  return (
    <section
      ref={containerRef}
      className="flex-1 overflow-y-auto p-4 h-full bg-dark-900"
      style={{
        overflowY: "auto",
        overscrollBehavior: "contain",
        backgroundImage: "url('/dark-whatsapp-bg.png')",
              ...
              >
                {showDate && dateText && (
                  <header className="flex justify-center my-3">
                    <time
                      className="text-xs bg-dark-700 px-3 py-1 rounded-full text-dark-200"
                      dateTime={
